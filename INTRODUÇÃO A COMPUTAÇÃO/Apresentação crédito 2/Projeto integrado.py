...
produtos_precos = {
    1: {"nome": "aço", "preco": 8.99, "almoxarifado": "Aco"},
    2: {"nome": "madeira", "preco": 49.99, "almoxarifado": "Madeira"},
    3: {"nome": "gesso", "preco": 8.99, "almoxarifado": "Gesso"},
    4: {"nome": "vidro", "preco": 2.50, "almoxarifado": "Vidro"},
    5: {"nome": "argamassa", "preco": 14.99, "almoxarifado": "Argamassa"},
    6: {"nome": "tijolos", "preco": 1.99, "almoxarifado": "Tijolos"},
    7: {"nome": "telhas", "preco": 1.99, "almoxarifado": "Telhas"},
    8: {"nome": "isolamentos", "preco": 14.99, "almoxarifado": "Isolamentos"},
    9: {"nome": "ferro", "preco": 8.99, "almoxarifado": "Ferro"},
    10: {"nome": "viga", "preco": 8.99, "almoxarifado": "Viga"},
    11: {"nome": "brita", "preco": 129.99, "almoxarifado": "Brita"},
    12: {"nome": "tabua", "preco": 79.99, "almoxarifado": "Tabua"},
    13: {"nome": "concreto", "preco": 314.99, "almoxarifado": "Concreto"},
    14: {"nome": "Areia", "preco": 199.99, "almoxarifado": "Areia"},
    15: {"nome": "Cimento", "preco": 39.99, "almoxarifado": "Cimento"}
}

# Promoção dos Produtos
def promocao():
    for key, produto in produtos_precos.items():
